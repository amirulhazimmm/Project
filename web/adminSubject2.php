              ...
              <h2 class="w3_inner_tittle">Subject</h2>
                    ...
                    <div class="agile-tables">
                      <div class="w3l-table-info agile_info_shadow">
                        <h3 class="w3_inner_title two">Insert Subject</h3><br>
                        <form>
                          <table class="table table-hover">
                            <tr>
                              ...
                              <td>
                                <input type="text" class="form-control" name="sbjName">
                              </td>
                              <td>
                              ...
                              <td>
                                <input type="button" class="btn btn-primary" name="submit" value="Insert Subject">
                              </td>
                            </tr>
                          </table>
                        </form>
                  ...
                  <div class="inner_content_w3_agile_info two_in">
                              ...
                              <table class="table table-hover">
                                ...
                                <tr>
                                  ...
                                  <td><button><span class="fa fa-cog"></span></button></td>
                                  <td><button><span class="fa fa-times"></span></button></td>
                                </tr>
