<?php
	...
	$query = mysqli_query($db, $sql);
	$clsNo = mysqli_num_rows($query);
	$disCarryM = mysqli_num_rows($query);
									...
									<li>
										<a href="viewClass.php">
											...
											<div class="ca-content">
												<h4 class="ca-main two"><?=$clsNo;?></h4>
												<h3 class="ca-sub two">View Class</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="insertStudent.php">
											...
											<div class="ca-content">
												<h4 class="ca-main two"><?=$clsNo;?></h4>
												<h3 class="ca-sub two">Insert Student Details</h3>
											</div>
										</a>
									</li>
									
									<li>
										<a href="insCarryMark.php">
											<i class="fa fa-building-o" aria-hidden="true"></i>
											<div class="ca-content">
												<h4 class="ca-main">100,000</h4>
												<h3 class="ca-sub">Insert/Update Carry Mark</h3>
											</div>
										</a>
									</li>
									<li>
										<a href="viewClass2.php">
											<i class="fa fa-database" aria-hidden="true"></i>
											<div class="ca-content">
											<h4 class="ca-main two"><?=$disCarryM;?></h4>
												<h3 class="ca-sub two">Display Carry Mark</h3>
											</div>
										</a>
									</li>
						 ...
						 <!--/prograc-blocks_agileits-->
							<div class="prograc-blocks_agileits">
								<div class="col-md-6 fallowers_agile agile_info_shadow">
									<h3 class="w3_inner_tittle two">Classes</h3>
